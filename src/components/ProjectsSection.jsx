...
const projects = [
  {
    title: "Spark Hub",
    description:
      "SparkHub is an e-learning platform for electronic components, offering tutorials, datasheets, 3D models, quizzes, and a blog section, and interactive tools.",
  ...
  },
  {
    title: "Book it",
    description:
      "Book-it is a Vite MERN-based digital hall booking system with seamless event scheduling, automated notifications, and scheduled jobs for efficient booking lifecycle management.",
  ...
  },
  {
    title: "Savemytaxes",
    description:
      "SaveMyTaxes.in is a tax-saving consultancy firm that assists individuals and businesses with tax filings, compliance, and smart tax-saving strategies.Consists of a userapp , adminapp and landing page. Currently under reconstruction. Checkout my github for proof of work.",
...
const ProjectsSection = () => {
  return (
    <section className="mb-12 px-4">
      ...
      <Link
        href={"https://github.com/kathirKarthik001?tab=repositories"}
        target="_blank"
        className=" mt-7 text-lg font-semibold text-white   hover:text-white flex w-full h-5 justify-center mb-14"
      >
...
const ProjectCard = ({
  ...
  return (
    ...
    >
      {/* Image Section */}
      <div className="w-full bg-gray-900/40 md:w-[40%]">
        <Image
          src={imageUrl}
          alt={title}
          width={500}
