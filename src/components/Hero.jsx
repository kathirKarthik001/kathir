  ...
  return (
    ...
    <section className="flex flex-col justify-center md:flex-row-reverse md:justify-evenly gap-1 items-center text-center p-6 md:p-12 mb-4 h-[80vh]">
      ...
      <div className="md:text-left">
        ...
        <h1 className="text-3xl md:text-6xl text-white font-bold mt-6">I'm Kathir</h1>
        <p className="text-lg md:text-2xl text-white mt-2">Student & Developer</p>
        ...
        <div className="flex gap-2">
          ...
          <Link href={'#contact'} className="border-gray-700 border-2 rounded py-3 px-6 mt-3 text-white hover:bg-gray-900/40  z-50">
            Contact
          </Link>
        </div>
      </div>  
