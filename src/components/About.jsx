      ...
      <section className="flex flex-col-reverse md:flex-row md:justify-evenly gap-1 items-center  p-6 md:p-3  mb-7 md:h-[80vh] ">
        ...
        <div className=" flex flex-col  p-4 items-center justify-evenly w-full text-gray-400 md:w-[60%] h-full">
          ...
          <div className="mb-3">
            ...
            <p className=" text-[15px] text-white md:text-justify md:text-xl font-semibold my-3">
              I'm Kathir, a passionate and self-taught software developer. With
              a strong foundation in design and a tireless work ethic, I thrive
              on turning ideas into functional, user-friendly solutions.
            </p>
            <p className=" text-[12px] md:text-[17px] md:text-justify">
              Driven by curiosity and ambition, I am constantly seeking
              opportunities to learn, grow, and evolve in the ever-changing tech
              landscape.
            </p>
          </div>
          ...
          <div className=" self-start flex items-center text-white gap-6 justify-start  md:gap-7 w-full md:w-[80%] p-1 md:p-2 h-12 ">
            ...
            <Link
              href="https://leetcode.com/u/Kathirkarthik001/"
              target="_blank"
            >
